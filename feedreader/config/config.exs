...
config :feedreader, FeedreaderWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: FeedreaderWeb.ErrorHTML, json: FeedreaderWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Feedreader.PubSub,
  live_view: [signing_salt: "c9Zb3rBo"]
...
config :feedreader, Feedreader.Mailer, adapter: Swoosh.Adapters.Local
